...
- **ОТКРИТО, НЕ Е ПОПРАВЕНО: повторени имена на атрибути в ASBIS** — `extractAttrList` е HashMap → последната печели. 1170 случая в 669 продукта: Височина/Дълбочина (продукт и опаковка), LAN (259: „Gigabit Ethernet / 10G Ethernet“ + „1 (RJ-45)“), WAN, Ширина, USB тип C.
