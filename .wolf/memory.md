...
| 12:50 | Edited src/main/java/com/techstore/service/ProductService.java | added 2 import(s) | ~43 |
| 12:50 | Edited src/main/java/com/techstore/service/ProductService.java | 3→6 lines | ~44 |
| 12:50 | Edited src/main/java/com/techstore/service/ProductService.java | 3→6 lines | ~105 |
| 12:51 | Session end: 6 writes across 4 files (pom.xml, logback-spring.xml, docker-compose.yml, ProductService.java) | 6 reads | ~17188 tok |
| 12:52 | Session end: 6 writes across 4 files (pom.xml, logback-spring.xml, docker-compose.yml, ProductService.java) | 6 reads | ~17188 tok |
| 12:53 | Session end: 6 writes across 4 files (pom.xml, logback-spring.xml, docker-compose.yml, ProductService.java) | 6 reads | ~17188 tok |
| 12:56 | Edited ../../care-tech-ui/src/pages/admin/Products/ProductForm.jsx | 6→4 lines | ~62 |
| 12:56 | Session end: 7 writes across 5 files (pom.xml, logback-spring.xml, docker-compose.yml, ProductService.java, ProductForm.jsx) | 6 reads | ~17250 tok |
...
| 11:45 | Edited SEARCH_AUDIT_PLAN.md | expanded (+32 lines) | ~453 |
...
| 12:55 | Session end: 107 writes across 30 files (prod_db_readonly_access.md, search_visibility_findings.md, MEMORY.md, SEARCH_AUDIT_PLAN.md, 47_fix_most_prices_to_eur.sql) | 18 reads | ~174927 tok |
| 12:59 | СТЪПКА 1 ПОТВЪРДЕНА НА ПРОД след MOST sync: 144 захранвания, 137 мобилни аксесоари, 76 проектора преместени; "Мобилни телефони" 240->104 и отпадна от подозрителните. Регресията не се случи (Чанти 43, Зарядни 24 запазени). Открито: CONTR I/O няма subcategory изобщо -> "Входно-изходни контролери" не се решава с двойки | CATEGORY_CLEANUP_PLAN.md | стъпка 1 приключена | ~14k |
| 13:00 | Created ../../../../../../tmp/step1_result.md | — | ~454 |
| 13:00 | Session end: 108 writes across 31 files (prod_db_readonly_access.md, search_visibility_findings.md, MEMORY.md, SEARCH_AUDIT_PLAN.md, 47_fix_most_prices_to_eur.sql) | 18 reads | ~175413 tok |
| 13:04 | Created ../../../../../../tmp/step2_analysis.md | — | ~905 |
| 13:05 | АНАЛИЗ ЗА СТЪПКА 2: проблемът е паднал 726->601 видими продукта; концентриран (топ 20 = 80%); съвпадение по име покрива само 44; КЛЮЧОВО - 7 от 35 цели на MOST мапинга сочат САМО към скрити категории (1705 продукта); "Мрежов хардуер" и "Охладители" са 100% MOST, тоест не са ASBIS проблем -> стъпка 2 се разделя на 2а (MOST мапинг) и 2б (ASBIS миграция) | CATEGORY_CLEANUP_PLAN.md | анализът е завършен, чака решение | ~30k |
...
| 14:05 | Session end: 120 writes across 38 files (prod_db_readonly_access.md, search_visibility_findings.md, MEMORY.md, SEARCH_AUDIT_PLAN.md, 47_fix_most_prices_to_eur.sql) | 18 reads | ~185704 tok |
| 14:11 | СТЪПКА 3 АНАЛИЗ -> ПРЕПОРЪЧВАМ ДА НЕ СЕ ПРАВИ: от 519 празни листни ASBIS категории само 216 са безопасни (303 още са във feed-а и биха се пресъздали ВИДИМИ), а нито една от 216-те не решава сблъсък по име. Открит bug-510: createCategory слага show=true, sortOrder=0 | buglog, cerebrum | ASBIS категорийният sync не е в нощния крон (последно 2026-08-06) | ~20k |
...
| 15:44 | Created scripts/55_filters_curated_06_audio.sql | — | ~6117 |
...
| 17:12 | Created scripts/55_filters_curated_11_small_categories.sql | — | ~5451 |
...
| 11:54 | Session end: 2 writes across 2 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql) | 1 reads | ~16802 tok |
...
| 12:31 | Session end: 4 writes across 4 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql) | 1 reads | ~20488 tok |
| 13:40 | Прод след скриптове 56/57 + rebuild #7 (30.4 s): 67/67 преместени, флагнати и видими (49 с филтърни стойности); 32/32 спрени; 0 видими продукта в скрити категории; 0 дублирани групи; на живо i5-14500 в Процесори, столове Refine в Геймърски столове, търсене без уредите | прод (само четене), caretech.bg | ok | ~6k |
| 12:34 | Session end: 4 writes across 4 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql) | 1 reads | ~20488 tok |
| 12:37 | Session end: 4 writes across 4 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql) | 1 reads | ~20488 tok |
| 12:40 | Created scripts/58_smart_devices_and_access_control.sql | — | ~1801 |
| 14:00 | Скрипт 58: 13 продукта към видими категории, 548 видима под Видеонаблюдение („Контрол на достъп“), 500 видим корен „Смарт устройства“ (sort 21), 6 продукта обратно в продажба; икона TbSmartHome за smart-ustroystva във фронтенда; локален тест OK, npm build OK | scripts/58_*.sql, care-tech-ui src/utils/navIcons.js | чака пускане + деплой на фронтенда | ~20k |
| 12:43 | Session end: 5 writes across 5 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql, 58_smart_devices_and_access_control.sql) | 1 reads | ~22417 tok |
| 14:30 | Скрипт 58 в DBeaver: 25P03 idle-in-transaction timeout, нищо не е записано (проверено в прод). Пренаписан като един DO блок; локално: минава, откат OK, повторно пускане спира на проверката | scripts/58_smart_devices_and_access_control.sql | чака повторно пускане | ~10k |
| 12:47 | Session end: 5 writes across 5 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql, 58_smart_devices_and_access_control.sql) | 1 reads | ~22417 tok |
| 12:49 | Session end: 5 writes across 5 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql, 58_smart_devices_and_access_control.sql) | 1 reads | ~22417 tok |
| 12:52 | Session end: 5 writes across 5 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql, 58_smart_devices_and_access_control.sql) | 1 reads | ~22417 tok |
| 15:00 | Скрипт 58: NOTICE при потребителя, но в прод нищо — pg_stat_activity показа DBeaver SQLEditor „idle in transaction“ → Manual commit, отменено след 60 s. Добавен COMMIT в края; локално тествано в ръчен и auto-commit режим | scripts/58_smart_devices_and_access_control.sql | чака повторно пускане | ~8k |
| 12:59 | Session end: 5 writes across 5 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql, 58_smart_devices_and_access_control.sql) | 1 reads | ~22417 tok |
| 13:01 | Session end: 5 writes across 5 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql, 58_smart_devices_and_access_control.sql) | 1 reads | ~22417 tok |
| 13:03 | Session end: 5 writes across 5 files (55_filters_curated_13_unmapped_cleanup.sql, 55_filters_curated_14_twins_and_long_tail.sql, 56_move_products_out_of_hidden_categories.sql, 57_retire_remaining_home_appliances.sql, 58_smart_devices_and_access_control.sql) | 1 reads | ~22417 tok |
| 15:15 | Скрипт 58 пуснат от потребителя с psql (PGPASSWORD от .env) — в прод: 500 видим корен (sort 21, „Smart devices“), 548 „Контрол на достъп“ под 230, 13 продукта преместени и флагнати, 6 обратно в продажба, 0 видими в скрити категории; на живо: API /categories връща и двете, bundle съдържа иконата smart-ustroystva. Остава rebuild | прод (само четене), caretech.bg | ok | ~6k |
