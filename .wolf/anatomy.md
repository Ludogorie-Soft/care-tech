...
> Auto-maintained by OpenWolf. Last scanned: 2026-09-24T14:12:21.200Z
> Files: 731 tracked | Anatomy hits: 0 | Misses: 0
...
- `55_filters_curated_09_accessories.sql` — Курация партида 9 (аксесоари): Чанти за лаптопи(40), Калъфи за телефони(163)/таблети(41), Геймърски падове(173), Столове(169), Уеб камери(60), Термопасти(14), Наливни мастила(90); 16 свойства, 28 групи; размер на пад по ПЪРВАТА мярка в името; копира правилата за мастилата от 87 (55_04); regex guard (~10000 tok)
- `55_filters_curated_09_accessories.sql` — ============================================================================ (~6449 tok)
...
- `CapacityGbParser.java` — CAPACITY_GB: 2x8GB → 16, 1TB → 1000, 2048GB → 2000; голо „128“ (целият текст) → 128 GB; „150MB/s“ не е капацитет; „0 GB“ (барбоун) → празно; етикети GB/TB/MB (~870 tok)
