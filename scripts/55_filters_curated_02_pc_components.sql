...
FROM (VALUES
    ...
    ('cpu-socket', 'AM4',     '(^|[^[:alnum:]])am4([^[:alnum:]]|$)'),
    ('cpu-socket', 'AM5',     '(^|[^[:alnum:]])am5([^[:alnum:]]|$)'),
    ('cpu-socket', 'LGA1851', '(^|[^0-9])1851([^0-9]|$)'),
    ('cpu-socket', 'LGA1700', '(^|[^0-9])1700([^0-9]|$)'),
    ('cpu-socket', 'LGA1200', '(^|[^0-9])1200([^0-9]|$)'),
    ('cpu-socket', 'LGA1151', '(^|[^0-9])1151([^0-9]|$)'),
    ('cpu-socket', 'LGA1150', '(^|[^0-9])1150([^0-9]|$)'),
    ('cpu-socket', 'LGA1155', '(^|[^0-9])1155([^0-9]|$)'),
